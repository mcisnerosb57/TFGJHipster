...
@SpringBootTest(classes = ArtefactCheckApp.class)
public class ArtefactoResourceIntTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(artefactoResource, "artefactoRepository", artefactoRepository);
