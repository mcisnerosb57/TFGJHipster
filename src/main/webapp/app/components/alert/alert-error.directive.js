(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('artefactCheckApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-artefactCheckApp-error');
                var entityKey = httpResponse.headers('X-artefactCheckApp-params');
                if (errorHeader) {
